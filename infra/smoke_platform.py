...
def main():
    ...
    admin_name, demo_name, third_name = (
        "qa.admin." + suffix,
        "qa.demo." + suffix,
        "qa.client." + suffix,
    )
    ...
    browser, demo_browser = Browser(), Browser()
    try:
        try:
            ...
            json.dumps(
                {
                    ...
                    "requests": browser.requests + demo_browser.requests,
                }
            ),
            flush=True,
        )
        ...
        User.objects.filter(username__in=[admin_name, demo_name, third_name]).update(
            is_active=False
        )
